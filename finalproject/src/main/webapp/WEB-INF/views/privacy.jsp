...
<h2 id="privacyTitle"><strong>개인정보 처리방침</strong></h2>
<div id="privacy">
<p class="ls2 lh6 bs5 ts4">
	<em class="emphasis"><9 O' Clock>(' 9 O' Clock' 이하'9 O' Clock ')</em>은(는) 
	「개인정보 보호법」 제30조에 따라 정부주체의 개인정보를 보호하고 이와 관련한 고충을 
	신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.
</p>

<p class="ls2">
	○ 이 개인정보처리방침은 <em class="emphasis">2021</em>년 
	<em class="emphasis">5</em>월 <em class="emphasis">24</em>
	부터 적용됩니다.
</p></br>
...
<p class=' lh6 bs4 '>
	...
	별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.</strong>
</p>

<ul class="list_indent2 mgt10">
    <p class="ls2">1. 홈페이지 회원가입 및 관리</p>
    <p class="ls2">회원 가입의사 확인, 회원제 서비스 제공에 따른 
	...
	<p class="ls2">민원인의 신원 확인, 민원사항 확인, 사실조사를 위한 
	연락·통지, 처리결과 통보 목적으로 개인정보를 처리합니다.</p></br>
	<p class="ls2">3. 재화 또는 서비스 제공</p>
	<p class="ls2">서비스 제공, 계약서·청구서 발송, 콘텐츠 제공, 
	맞춤서비스 제공, 본인인증, 요금결제·정산을 목적으로 개인정보를 
	처리합니다.</p></br>
</ul></br></br>

<p class='lh6 bs4'>
	<strong>제2조(개인정보의 처리 및 보유 기간)</strong></br></br>
	①<em class="emphasis"><9 O' Clock></em>은(는) 법령에 따른 
...
<p class="ls2"><br/><br/>
	① 정보주체는 9 O' Clock에 대해 언제든지 개인정보 열람·정정·삭제·처리정지 
	요구 등의 권리를 행사할 수 있습니다.
</p>

<p class='sub_p'>
	② 제1항에 따른 권리 행사는 9 O' Clock에 대해 「개인정보 보호법」 
	시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 
	9 O' Clock은(는) 이에 대해 지체 없이 조치하겠습니다.
</p>
...
<p class='sub_p'>
	⑥ 9 O' Clock은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구, 
...
<p class='lh6 bs4'>
    ...
    ①<em class="emphasis"><9 O' Clock></em>은(는) 다음의 개인정보 항목을 
    처리하고 있습니다.
</p>

<ul class=' list_indent2 mgt10 '>
	<li class=' tt '>1< 홈페이지 회원가입 및 관리 ></li>
	<li>필수항목 : 이메일, 휴대전화번호, 비밀번호, 로그인ID, 이름, 부서, 
	회사명, 신용카드정보, 은행계좌정보, 서비스 이용 기록, 접속 로그, 쿠키, 
	접속 IP 정보, 결제기록</li>
</ul></br></br>
...
<p class=' ls2 '></br>
	① <9 O' Clock>은(는) 개인정보 보유기간의 경과, 처리목적 달성 등 
	...
	1. 보존하는 개인정보 항목 : 계좌정보, 거래날짜</br></br>
	③ 개인정보 파기의 절차 및 방법은 다음과 같습니다.</br>
	1. 파기절차</br><9 O' Clock> 은(는) 파기 사유가 발생한 개인정보를 선정하고, 
	<9 O' Clock>의 개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다.</br>
</p>
...
<p class='lh6 bs4'>
    <strong>제6조(개인정보의 안전성 확보 조치)<em class="emphasis"></br></br>
    <9 O' Clock></em>은(는) 개인정보의 안전성 확보를 위해 다음과 같은 조치를 
    취하고 있습니다.</strong>
</p>
...
<p class=' sub_p mgt10 '>
	...
	개인정보를 관리하는 대책을 시행하고 있습니다.</br></br>
	3. 내부관리계획의 수립 및 시행</br> 
	개인정보의 안전한 처리를 위하여 내부관리계획을 수립하고 시행하고 있습니다.</br></br>
	4. 해킹 등에 대비한 기술적 대책</br> 
	<<em class="emphasis">9 O' Clock </em>>('<em class="emphasis">9 O' Clock</em>')은 
	...
	6. 접속기록의 보관 및 위변조 방지</br>개인정보처리시스템에 접속한 기록을 
	최소 6개월 이상 보관, 관리하고 있으며, 접속 기록이 위변조 및 도난, 분실되지 않도록 
...
<p class="ls2">
    <br/><br/>
    ① 9 O' Clock 은(는) 이용자에게 개별적인 맞춤서비스를 제공하기 위해 이용정보를 
	...
	인기 검색어, 보안접속 여부, 등을 파악하여 이용자에게 최적화된 정보 제공을 위해 사용됩니다.<br/>
...
<p class='sub_p mgt10'>
    ①  <span class='colorLightBlue'>9 O' Clock</span>은(는) 개인정보 처리에 관한 
...
<ul class='list_indent2 mgt10'>
    ...
    <li>담당자 :9 O' Clock 개발자</li>
    <li>연락처 :project210413@gmail.com </li>
</ul>

<p class='sub_p'>
	② 정보주체께서는 9 O' Clock 의 서비스(또는 사업)을 이용하시면서 발생한 
	모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 
	보호책임자 및 담당부서로 문의하실 수 있습니다. 
	9 O' Clock 은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.
</p>

<p class='sub_p mgt30'>
    <strong>제9조(개인정보 열람청구)</br>
    정보주체는 ｢개인정보 보호법｣ 제35조에 따른 개인정보의 열람 청구를 아래의 부서에 할 수 있습니다.<br/>
    <9 O' Clock></span>은(는) 정보주체의 개인정보 열람청구가 신속하게 처리되도록 노력하겠습니다. </strong>
</p>
...
<p class='lh6 bs4 '>
	...
	정하는 바에 따라 행정심판을 청구할 수 있습니다.<br/><br/>
...
<p class='sub_p '>
	① 이 개인정보처리방침은 2021년 5월 24부터 적용됩니다.
</p>
</div>
</div>
