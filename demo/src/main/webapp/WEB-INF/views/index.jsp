...
<div class="content"><!--content start-->
		<div id="carouselExampleFade" class="carousel slide carousel-fade "
			data-ride="carousel"><!-- carousel start-->
		...
		<div class="container-fluid"><!--center start-->
			<div class="row r3">
				<div class="col">
					<h2>Service</h2>
			...
			<div class="row r4">
				<div class="col">
					<div class="card">
						<a href="#"><img src="imgs/home-service-PC.png"
							class="card-img-top" alt="..."></a>

						<div class="card-body">
							<h3 class="card-title">서비스</h3>
							<p class="card-text">회사 규모, 필요 기간에 맞춰 쉽고 빠르게 사무공간을 마련할 수
								있습니다.</p>
						</div>
					</div>
				</div>
				<div class="col">
					<div class="card">
						<a href="#"><img src="imgs/home-place-PC.png"
							class="card-img-top" alt="..."></a>
						<div class="card-body">
				...
				<div class="col">
					<div class="card">
						<a href="#"><img src="imgs/home-member-PC.png"
							class="card-img-top" alt="..."></a>
						<div class="card-body">
