...
//	// 비밀번호 찾기 이메일 전송
//	 public void pwChangeMail(String to) throws MessagingException {
//	    	System.out.println("[MailService(pwChangeMail)]");
//	    	System.out.println("[MailService(pwChangeMail)] from: "+emailBean.getFrom());
//	    	// emailInput값 받아와야함
//	    	System.out.println("[MailService(pwChangeMail)] to: "+to);
//	    	// properties 설정
//		    Properties props = new Properties();  
//		    props.setProperty("mail.transport.protocol", emailBean.getProtocol());
//		    props.setProperty("mail.host", emailBean.getHost());
...
//		    mimeMessage.setFrom(new InternetAddress(emailBean.getFrom()));
//		    mimeMessage.setRecipient(Message.RecipientType.TO, new InternetAddress(to));
//		    mimeMessage.setSubject("[9'o clock] 비밀번호를 변경해주세요.");
//
//		    // 메일 본문
//		    msg="<table width='90%' cellpadding='0' cellspacing='0' border='0' align='center' style='margin:0 auto;table-layout:fixed;border-collapse: collapse'>";
//		    msg+="<tbody>";
//		    msg+="<tr style='background-color:#e2e4f3;text-align:center'>";
//		    msg+="<td width='100%' style='padding:40px;border-radius:10px;font-size:12px;'>";
//		    msg+="<font size=6><strong>9'o Clock 비밀번호 변경</strong></font>";
//		    msg+="<p style='padding-top:30px'>회원님의 아이디로 비밀번호 찾기 요청이 있었습니다."
//		    		+ "<br>아래의 링크로 이동해서 비밀번호를 변경해주세요.</p>";
//		    msg+="<p style='font-size:13px;text-decoration:underlined'><strong>비밀번호 변경: (링크)";
//		    msg+=code+"</strong></p>";
//		    msg+="</td>";
//		    msg+="</tr>";
//		    msg+="</tbody>";
//		    msg+="</table>";
//		    System.out.println("[MailService(pwChangeMail)] msg: "+msg);
//		    mimeMessage.setContent(msg, "text/html;charset=utf-8");
//		    
//		    // 메일 발송
//		    transport.connect();  
